...
def train(args):
    ...
    for iteration in tqdm(range(current_iteration, total_iterations + 1)):
     ...
     #   errg = []
     #   errd = []
     #   errg.append(err_g.item())
     #   errd.append(err_dr)
   # plt.figure(figsize=(10, 5))
   # plt.title("Genertaor and Discriminator Loss of Training")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', type=str, default='E:\Results-0628\BCI\BCI Dataset\GAN-train-500\sub7',
                        help='path of resource dataset, should be a folder that has one or many sub image folders inside')
    parser.add_argument('--cuda', type=int, default=0, help='index of gpu to use')
    parser.add_argument('--name', type=str, default='test07', help='experiment name')
    ...
    #parser.add_argument('--ckpt', type=str, default='./checkpoint/all_100000.pth', help='checkpoint weight path if have one')
